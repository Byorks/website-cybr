...
scrollToTopBtn.className =
  "fixed bottom-6 right-6 w-12 h-12 bg-primary-500 text-white rounded-full flex items-center justify-center opacity-0 cursor-pointer pointer-events-none transition-opacity duration-300 hover:bg-primary-700 z-40";
